...
export class PlayerService {
  ...
  private playersUrl = 'http://team-game.pommine-fillatre.com';  // URL to web api
  ...
  getPlayers(): Observable<Player[]> {
    const url = `${this.playersUrl}/list/all/players`;
  ...
  getPlayer(id: number): Observable<Player> {
    const url = `${this.playersUrl}/get/player/${id}`;
  ...
  updatePlayer(player: Player): Observable<any> {
    const url = `${this.playersUrl}/modify/player/${FormData}`;
   ...
   startGame(): Observable<any> {
    const url = `${this.playersUrl}/game/create`;
  ...
  gameResult(): Observable<any> {
    const url = `${this.playersUrl}/game/result/${FormData}`;
    return this.http.put(url, this.httpOptions).pipe(
